...
def getWebpage():
    global eu1,eu2,eu3,eu4,eu5,eu6,eu7,eu8,eu9,eu10,eumid1,euovz,id1,usla,usla2,allvps
    params = getParams()
    ...
    usla2 = allVPS[13].string.replace(' VPS', '')
