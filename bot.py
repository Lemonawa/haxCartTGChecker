...
def getWebpage():
    global eu1,eu2,eu3,eu4,eu5,eu6,eu7,eu8,eu9,eu10,eumid1,euovz,id1,usla,usnyc,allvps
    params = getParams()
    ...
    usnyc = allVPS[11].string.replace(' VPS', '')
    id1 = allVPS[12].string.replace(' VPS', '')
    usla = allVPS[13].string.replace(' VPS', '')
    euovz = allVPS[14].string.replace(' VPS', '')
    allvps = allVPS[15].string.replace(' VPS', '')
